...
- Each round lasts **5 minutes**. The countdown appears at the top of the game. When it reaches `0:00`, guessing stops immediately and characters without a correct guess receive 0 points.
